...
var links = [
    {label: 'Missoes', bg: 'black', href: '/cadastrar-missao.html'},
    {label: 'Sobrevivente', bg: 'black', href: '/cadastrar-sobrevivente.html'}, 
    {label: 'Recursos', bg: 'black', href: '/cadastrar-recurso.html'}
    ];
...
circle.style.left = radius*-1.5+'px';
}
...
link.style.left = borderSize*-25+'px';
link.style.top = (windowHeight/2) - (windowHeight*0.1)+borderSize+'px';

hover.style.left = borderSize*-25+'px';
hover.style.borderRadius = "20px";
...
hover.style.borderLeft = borderSize*2+'px solid #fff';
